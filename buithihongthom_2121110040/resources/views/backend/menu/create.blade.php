                        ...
                        <div class="row">
                            <div class="col-6">
                                <div>
                                    ...
                                    <input type="text" name="name" list="name" placeholder="Nhập vào tên menu"
                                        class="form-control">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="link" list="name" placeholder="Nhập link"
                                        class="form-control">
                            ...
                            <div class="col-6">
                                ...
                                <div>
                                    <label for="" class="form-label">Chọn vị trí</label>
