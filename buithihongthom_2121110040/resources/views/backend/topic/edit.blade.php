                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8 ">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" value="{{ $topic->name }}" type="text"
                                                    class="form-control" placeholder="Nhập tên danh mục" value="">

                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Từ khóa</label>
                                                <textarea name="metakey" class="form-control" rows="3" placeholder="Nhập tên danh mục">{{ $topic->metakey }}"</textarea>

                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Từ khóa</label>
                                                <textarea name="metadesc" class="form-control" rows="3" placeholder="Nhập tên danh mục">{{ $topic->metadesc }}"</textarea>
                                        ...
                                        <div class="col-md-4 ">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">cấp cha</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input value="{{ $topic->image }}" name="image" type="file"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="mb-3">
