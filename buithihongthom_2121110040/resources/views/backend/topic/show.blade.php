...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-topic active">Chi tiết sản phẩm</li>
            </ol>
          </div>
        </div>
        <div class="d-flex justify-content-end">
          <div class="">
            <a class=" btn btn-sm btn-primary"  href="{{ route('topic.index') }}"><i class="fas fa-undo-alt"></i>Quay về danh sách</a>
   ...
   <table class="table table-bordered">
    <thead>
        ...
        <tr>
        <td class="fw-bold text-danger">Tên</td>
            <td>{{ $topic->name }}</td>
        </tr>
        ...
        <td class="fw-bold text-danger">Hình Ảnh</td>
          <td>
              <img width="50px" height="50px" src="{{ $topic->image }}" alt="{{ $topic->image }}">
          </td>
        </tr>
