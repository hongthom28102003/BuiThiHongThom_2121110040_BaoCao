                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-topic"><a href="{{ route('admin.dashboard') }}">Bảng điều khiển</a></li>
                            <li class="breadcrumb-topic active">Thùng rác thương hiệu</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="row"> 
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <a href="{{ route('topic.index') }}" class="btn bg-dark">
                    ...
                    <tbody>
                        @foreach ($topic as $topic)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img class="img-fluid" src="{{ asset('image/topic/' .$topic->image) }}"
                                        alt="{{ $topic->image }}">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('topic.restore', ['topic' => $topic->id]) }}" {{-- đường dẫn khi nhấp vào edit có tham số truyền vào nên phải có ->id  --}}
