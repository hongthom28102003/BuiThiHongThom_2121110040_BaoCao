                            ...
                            <div class="row">
                                <div class="col-md-8 ">
                                    <div class="mb-3">
                                        ...
                                        <input name="name" value="{{$contact->name}}" type="text" class="form-control"
                                            placeholder="Nhập tên danh mục" value="">
    
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Từ khóa</label>
                                        <textarea name="metakey" class="form-control" rows="3" placeholder="Nhập tên danh mục">{{$contact->metakey}}"</textarea>
    
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Từ khóa</label>
                                        <textarea name="metades" class="form-control" rows="3" placeholder="Nhập tên danh mục">{{$contact->metadesc}}"</textarea>
                                ...
                                <div class="col-md-4 ">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{$contact->image}}" name="image" type="file" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="mb-3">
