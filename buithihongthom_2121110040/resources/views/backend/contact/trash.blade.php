                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-contact"><a href="{{ route('admin.dashboard') }}">Bảng điều khiển</a></li>
                            <li class="breadcrumb-contact active">Thùng rác danh mục</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="row"> 
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <a href="{{ route('contact.index') }}" class="btn bg-dark">
                    ...
                    <tbody>
                        @foreach ($contact as $contact)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('contact.restore', ['contact' => $contact->id]) }}" {{-- đường dẫn khi nhấp vào edit có tham số truyền vào nên phải có ->id  --}}
