                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-contact"><a href="#">Bảng điều khiển</a></li>
                            <li class="breadcrumb-contact active">Chi tiết sản phẩm</li>
                        </ol>
                    </div>
                </div>
                <div class="d-flex justify-content-end">
                    <div class="">
                        <a class=" btn btn-sm btn-primary" href="{{ route('contact.index') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <td>
                            <img width="50px" height="50px" src="{{ $contact->image }}" alt="{{ $contact->image }}">
                        </td>
                        </tr>
