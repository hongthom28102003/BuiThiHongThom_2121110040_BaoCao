    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-category"><a href="#">Bảng điều khiển</a></li>
        ...
        <div class="d-flex justify-content-end">
          <div class="">
            <a class=" btn btn-sm btn-primary"  href="{{ route('category.index') }}">
   ...
   <table class="table table-bordered">
    <thead>
        ...
        <td class="fw-bold text-danger">Hình Ảnh</td>
          <td>
              <img width="50px" height="50px" src="{{ $category->image }}" alt="{{ $category->image }}">
          </td>
        </tr>
